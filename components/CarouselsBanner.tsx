      ...
      <div className="flex">
        {movies?.map((movie) => (
          <div key={movie?.id} className="flex-full min-w-0 relative">
            ...
            <div
              className="hidden lg:inline absolute mt-0 top-0 pt-40 xl:pt-52 lg:mt-40 left-0 z-20
            bg-transparent h-full w-full bg-gradient-to-r from-gray-900/90 via-transparent to-transparent 
